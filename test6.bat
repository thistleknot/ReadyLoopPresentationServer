...
"c:\program files\mozilla firefox\firefox.exe" "https://query1.finance.yahoo.com/v7/finance/download/^%5ESP500TR?period1=0%begin%&period2=%end%&interval=1d&events=history&crumb=XwK9tui4bLR"
